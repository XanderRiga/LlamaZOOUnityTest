...
public class MeshGenerator : MonoBehaviour {
	...
	void AssignVertices(Node[] points) {
		for (int i = 0; i < points.Length; i++) {
			if (points[i].vertexIndex == -1) { // hasn't been assigned already
	...
	bool isOutlineEdge(int vertexA, int vertexB) { // to be an outline edge, vertices cannot share more than one triangle
    ...
    public class Square {
		...
		public int configuration; // 16 possible configs, 4 bits
